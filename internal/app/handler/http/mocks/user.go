...
func (mr *MockUserServiceMockRecorder) GetUserImage(ctx, userID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUserServiceMockRecorder) RemoveUser(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUserServiceMockRecorder) SetUserImage(ctx, userID, img interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
