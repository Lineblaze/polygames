...
func (mr *MockFileRepositoryMockRecorder) Delete(ctx, fileName interface{}) *gomock.Call {
...
func (mr *MockFileRepositoryMockRecorder) Read(ctx, fileName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockFileRepositoryMockRecorder) Save(ctx, data, fileName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
